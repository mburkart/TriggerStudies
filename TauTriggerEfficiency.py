...
class TauLegEfficiencies(object):
    ...
    _file_dict = {
            "MC": "DYJetsToLLM50*v1",
            "DATA": "SingleMuon_Run2017?_31Mar2018v1_13TeV_MINIAOD",
            "EMB": "Embedding2017?_MuTauFinalState_inputDoubleMu94XminiAODv2_13TeV_USER_v2",  # noqa: E501
        }
...
class Efficiency(object):
    ...
    bins = yaml.load(open("config.yaml", "r"))["bins"]
